...
export const elevatorPitch =
  "I help startups and businesses turn ideas into reality—from information systems and product design through to shipped software—with 6+ years across ERP, SaaS, EHR, mobile, and workflow-heavy systems.";
...
export const professionalSummary = {
  lead: `With 6+ years in information systems, I combine consulting on how businesses work and how they should be supported, with full-stack and automation delivery—across ERP, health information systems, data platforms, and enterprise integration.`,
...
export const enterpriseSystems = {
  ...
  programs: [
    {
      name: "National Social Safety-Nets Coordinating Office Management Information System — World Bank Sponsored Project",
    ...
    {
      name: "Nigeria for Women Project — Management Information System — World Bank Sponsored Project",
...
/** Default Projects section tab on the home page (not &quot;All&quot;) */
export const defaultPortfolioCategoryFilter = "saas-web-app" as const satisfies ProjectPortfolioCategoryId;
